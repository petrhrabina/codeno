...
declare module "vscode" {
    ...
    export class WorkspaceEdit {
        ...
        set(
            uri: Uri,
            edits: ReadonlyArray<[NotebookEdit, WorkspaceEditEntryMetadata | undefined]>,
        ): void;
    ...
    export namespace window {
         ...
         */
        export const onDidChangeTerminalShellIntegration: Event<
         ...
         */
        export const onDidStartTerminalShellExecution: Event<
         ...
         * activated for the terminal.
         */
        export const onDidEndTerminalShellExecution: Event<
